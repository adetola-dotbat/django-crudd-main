...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\graceMan\Downloads\django-crudd-main\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\graceMan\Downloads\django-crudd-main\env\Scripts\deactivate.nu'
